            ...
            <div ref={footerRef} className="flex w-full flex-col">
                ...
                <div className="grid grid-cols-[1fr,1fr,1fr] smmaxw:grid-cols-1 smmaxw:gap-y-[40px]">
                    <div>
                        ...
                        >
                            ...
                            <div>
                                <a href="https://qw-russia.ru/" rel="noopener noreferrer" target="_blank"
                                   className="text-[14px] font-spaceMono font-medium cursor-pointer smmaxw:text-[13px]">
                                    QW
                                </a>
                            </div>
                            <div>
                                <a href="https://www.2chrg.com/" rel="noopener noreferrer" target="_blank"
                                   className="text-[14px] font-spaceMono font-medium cursor-pointer smmaxw:text-[13px]">
                                    2chrg
                                </a>
                            </div>
                            <div>
                                <span className="text-[14px] font-spaceMono font-medium smmaxw:text-[13px]">
                                    Bankir
                                </span>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <div className="relative">
                                <a onClick={() => emailClick(1)} href="mailto:alexkotov@gmail.com"
                                   className="text-[14px] font-spaceMono font-medium cursor-pointer smmaxw:text-[10px]">Почта</a>
                                <motion.div
                                ...
                                >
                                    <div className="flex items-center gap-x-[5px]">
                                        ...
                                        <Image width={12} height={12}
                                               className="w-full h-full max-w-[12px] max-h-[12px]" src="/svgs/check.svg"
                                               alt="check"/>
                                    </div>
                                </motion.div>
                            </div>
                            <div>
                                <a onClick={telegramClick} href="https://t.me/imkotec" rel="noopener noreferrer"
                                   target="_blank"
                                   className="text-[14px] font-spaceMono font-medium cursor-pointer smmaxw:text-[10px]">
                                    Телеграм
                                </a>
                            </div>
                        </motion.div>
                ...
                <div className="mt-[60px] mb-[60px]">
                    <div className="flex justify-between items-center">
                        <div>
                            <span
                                className="flex justify-start items-center gap-x-[5px] text-[16px] font-spaceMono font-medium smmaxw:text-[13px]">
                                <div className="max-w-[18px] max-h-[18px]">
                                     <Image width={12} height={12} className="w-full h-full" src="/svgs/copyright.svg"
                                            alt="copyright"/>
                                </div>
                                <a target="_blank" href="https://t.me/imkotec">
                        ...
                        <div className="flex gap-x-[10px] smmaxw:text-[13px]">
                            ...
                            <a onClick={githubClick} href="https://github.com/kotec666" rel="noopener noreferrer"
                               ...
                               className="text-[16px] font-spaceMono font-medium cursor-pointer smmaxw:text-[13px]">
                                <div className="max-w-[18px] max-h-[18px]">
                                    <Image width={12} height={12} className="w-full h-full"

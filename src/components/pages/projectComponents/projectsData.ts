export const projectsData = [
	...
	},
	{
		...
		href_url:"https://bankir.kg/",
		img_src:"url('/images/bankiProject.svg')"
	},
	{
		id: 3,
		projectName:"Аудиоплатформа",
		stack:["React", "TS", "Redux", "RTK Query", "Axios", "Socket.io", "Express", "Sequelize", "MySQL", "Passport", "OAuth 2.0"],
		myRole:"fullstack",
		projectRole: "pet",
		projectDescription:"Платформа на подобии spotify для прослушивания музыки. Возможности гостя: прослушивание музыки, поиск музыки, исполнителей, альбомов, музыки по жанрам. Возможности авторизованного пользователя: прослушивание музыки, поиск музыки, исполнителей, альбомов, музыки по жанрам, Добавление музыки в категорию \"Любимое\", просмотр профиля, возможность оставить заявку на получение роли исполнителя, общение в чате. Возможности исполнителя: загрузка/удаление музыки, музыкальных альбомов, общение в чате. Возможности администратора: добавление/удаление/редактирование жанров, альбомов, треков, отклонение/прием заявок на выдачу роли исполнителя пользователю, общение в чате.",
		href_url:"https://github.com/kotec666/react-audio-platform",
		img_src:"url('/images/audioPlatform.png')"
	},
]
...
//     projectName: string
//     stack: string[]
//     myRole: "fullstack" | "frontend" | "backend"
//     projectRole: "commercial" | "pet"
